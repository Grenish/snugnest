...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="border rounded-lg overflow-hidden w-[250px] h-[370px] bg-white flex flex-col">
      <img src={image.src} alt={title} className="w-full h-64 object-cover" />
      <div className="p-4 flex flex-col justify-between flex-grow">
        <div>
          <div className="flex justify-between items-center">
            <h2 className="font-bold text-lg mb-2 capitalize ">{title}</h2>
            {isEco && (
