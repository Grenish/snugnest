...
export default function NavBar() {
  ...
  return (
    <header className="p-2">
      <nav className="flex items-center justify-between p-2 w-[85%] m-auto">
        ...
        <div className=" font-semibold text-4xl Vaimek">
          <h2>SnugNest</h2>
        </div>
        <div className="flex gap-3 items-center">
          <div className="">
            <button className="flex items-center gap-1 hover:text-red-600 transition-colors duration-250 ease-in-out">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="22"
          ...
          <div className="">
            <button className="flex items-center gap-1 hover:text-yellow-600 transition-colors duration-250 ease-in-out">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="22"
          ...
          <div className="">
            <Suspense fallback={<Loading />}>
              <button
                ...
                className="flex items-center gap-1 hover:text-blue-600 transition-colors duration-250 ease-in-out"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
